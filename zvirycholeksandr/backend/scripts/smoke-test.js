...
const staticChecks = [
  ...
  ['Підключення теми головної', '/', 200, '/js/theme.js?v=2'],
  ...
  ['Калькулятор вартості', '/', 200, 'id="price-estimator"'],
  ['Платний експрес-аудит', '/', 200, '1 900 грн'],
  ['Аудит у формі заявки', '/', 200, 'data-type="audit"'],
  ...
  ['Підключення теми послуг', '/services/landing', 200, '/js/theme.js?v=2'],
